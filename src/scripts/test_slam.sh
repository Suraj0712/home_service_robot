...
xterm  -e  "source /home/sur/home_service_robot/devel/setup.bash; roslaunch turtlebot_gazebo gmapping_demo.launch" & 
...
xterm  -e  "source /home/sur/home_service_robot/devel/setup.bash; roslaunch turtlebot_teleop keyboard_teleop.launch"